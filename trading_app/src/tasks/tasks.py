...
celery = Celery('tasks', broker=f'redis://{REDIS_HOST}:{REDIS_PORT}/0', include=["tasks.tasks"])
# celery -A src.tasks.tasks:celery worker --loglevel=INFO --pool=solo          из ./trading_app/src запускать!
